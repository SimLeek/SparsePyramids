...
class RandMaxSparse(torch.nn.Module):
    ...
    def __init__(
            self,
            out_percent_nonzero: float = 0.05,
            make_sparse_tensor=True,
    ):
...
if __name__ == '__main__':
    from rand_sparse import RandSparse
    from std_sparse import StdSparse
    ...
    class sparsifier(torch.nn.Module):
        def __init__(self):
            ...
            self.sp2 = RandMaxSparse(out_percent_nonzero=.02, make_sparse_tensor=False)
